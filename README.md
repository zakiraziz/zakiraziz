<div style="background: linear-gradient(135deg, #F1FAEE, #A8DADC); padding: 20px; border-radius: 15px; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1);">
  <div style="text-align: center; margin-bottom: 20px;">
    <img src="https://files.oaiusercontent.com/file-CkNvebYhfEJWe7EpdPMDVR?se=2025-02-11T15%3A49%3A24Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3D7fc38e23-9f9f-4631-926b-f689f1005ed3.webp&sig=OlESCr/yPcyi0TfVFcQMa0wMAlIePUuZzDWZcacVssY%3D" style="width: 100%; border-radius: 10px; margin-bottom: 15px;" />
    <img src="https://files.oaiusercontent.com/file-PvLxFhXGuxUPFwVocyaB1U?se=2025-02-11T15%3A50%3A18Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3Dd0638351-7fec-4455-b58e-48a281349a91.webp&sig=owBb/i%2BlC4Ds4zk%2B7HAwIplzC0TXjBbAcS8pxAvuxsU%3D" alt="Profile Picture" 
         style="border-radius: 50%; width: 150px; height: 150px; border: 4px solid #1D3557; transition: transform 0.3s;" 
         onmouseover="this.style.transform='scale(1.1)'" 
         onmouseout="this.style.transform='scale(1)'" />
  </div>

  <h1 align="center" style="font-size: 3em; color: #1D3557; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
  ...
  <h3 align="center" style="color: #457B9D;">A Passionate Programmer from Pakistan</h3>      
  ...
  <div align="center">
    <a href="https://github.com/zakiraziz" 
       style="font-size: 1.2em; color: #E63946; text-decoration: none; font-weight: bold; transition: 0.3s;"
  ...
  <footer style="text-align: center; margin-top: 40px; color: #457B9D;">
